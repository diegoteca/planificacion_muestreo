...
fig_densidad_ivse_poblacion_muestra_i = ggplotly(fig_densidad_ivse_poblacion_muestra)
fig_densidad_ivse_poblacion_muestra_i
...
fig_densidad_ivse_dominios_i = ggplotly(fig_densidad_ivse_dominios)
fig_densidad_ivse_dominios_i
```
...
fig_densidad_ivse_region_i = ggplotly(fig_densidad_ivse_region)
fig_densidad_ivse_region_i
```
...
fig_densidad_ivse_area_i = ggplotly(fig_densidad_ivse_area)
fig_densidad_ivse_area_i
```
...
fig_densidad_ivse_tipo_est_adulto_i = ggplotly(fig_densidad_ivse_tipo_est_adulto)
fig_densidad_ivse_tipo_est_adulto_i
```
...
fig_densidad_ivse_nivel_i = ggplotly(fig_densidad_ivse_nivel)
fig_densidad_ivse_nivel_i
```
