...
df_muestra = df_muestra_final |> select(codigo, censal, ivse_std, pi_corregido, nudge_power, factor_ajuste_CENS_EPA, expansor_establecimiento, ponderador_establecimiento, muestra_adultos, n_estudiantes_muestra)

muestra_DEJAyAM = df_universo |> left_join(df_muestra, by = "codigo")
