...
La sección de las aplicaciones prácticas, principalmente por cuestiones de confidencialidad, no son reproducibles. Por otro lado, algunos *chunks* incuyen código de Pyhton.

```{r}
#| eval: false
# Código para activar librerias. 
# Instala también las librerías que se necesitan pero no están instaladas previamente
...
```{r}
#| label: libraries_r
pacman::p_load(survey, # Lumley
               svrep, # Freedman Ellis y Schneider
               srvyr, # Schneider
               surveycore, # surveyverse
               surveytidy, # surveyverse
               spak::pak("JDenn0514/surveywts"), # surveyverse
               sampling, # Tillé
               BalancedSampling, # Grafstrom
               Spbsampling, # Benedetti
               SamplingStrata, # Barcaroli
               stratallo, # Wójciak. Exact analytical solutions rather than relying on numerical approximations.
               PracTools, # Valliant
               tidyverse,
               janitor,
               here,
