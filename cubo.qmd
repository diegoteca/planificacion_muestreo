...
Lo anterior puede considerarse un viejo *desideratum* de los diseños muestrales aunque antes no había disponible algún algoritmo de cálculo aplicable de una manera generalizable y precisa que pudiera ser ejecutado o calculado de manera viable [@deville2004]. Eso es lo que precisamente logra el método del cubo. De manera alternativa, las muestras balanceadas pueden ser vistas como un tipo de calibración (@sec-calibración) integrada en el diseño de la muestra más que a la estimación de los estimadores [@tillé2011, pág. 216].
