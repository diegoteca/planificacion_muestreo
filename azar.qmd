...
Ejemplos de librerías para analizar datos producidos con diseños muestrales pueden considerarse [survey](https://r-survey.r-forge.r-project.org/survey/) y su correspondiente versión tidy [srvyr](http://gdfe.co/srvyr/). Estas librerías generalmente agregan metainformación al dataframe original que hace referencia al modo en que fue realizada la encuesta y esta información aporta la información necesaria para realizar estimaciones puntuales con sus respectivos errores standards o intervalos de confianza.

Ejemplos de librerías que sirvan para el diseño de las muestras y su posterior ajuste o
